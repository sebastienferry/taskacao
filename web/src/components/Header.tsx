      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex items-center bg-[var(--bg-tertiary)] p-0.5 rounded-lg border border-[var(--border-color)]">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-medium transition-all ${
              activeView === 'activities'
                ? 'bg-[var(--bg-secondary)] text-cyan-400 shadow-xs'
                : 'text-[var(--text-muted)] hover:text-[var(--text-primary)]'
            }`}
            title={t.header.activitiesView}
          >
            <Activity size={14} className={activeJobCount > 0 ? 'text-blue-400 animate-pulse' : ''} />
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-medium transition-all ${
              activeView === 'sync'
                ? 'bg-[var(--bg-secondary)] text-indigo-400 shadow-xs'
                : 'text-[var(--text-muted)] hover:text-[var(--text-primary)]'
            }`}
